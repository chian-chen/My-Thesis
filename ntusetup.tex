...
\ntusetup{
  ...
  title         = {基於遞迴最小平方法之實時神經視訊編碼碼率控制},
  title*        = {Real-Time Rate Control for Neural Video Coding via Recursive Least Squares},
  author        = {陳祈安},
  author*       = {Chi-An Chen},
  ID            = {R12942181},
  advisor       = {丁建均},
  advisor*      = {Jian-Jiun Ding},
  date          = {2026-01-16},         % 若註解掉，則預設為當天
  oral-date     = {2026-01-16},         % 若註解掉，則預設為當天
  DOI           = {10.6342/NTU202600297},
  keywords      = {神經視訊編碼、碼率控制、遞迴最小平方法、實時視訊通訊、DCVC-RT},
  keywords*     = {Neural Video Coding, Rate Control, Recursive Least Squares, Real-Time Video Communication, DCVC-RT},
}
